...
const MatchCard = ({ match }) => {
  ...
  return (
    <div 
      className="rounded-xl overflow-hidden shadow-lg mb-4 bg-white dark:bg-gray-800 relative"
      style={{ 
      ...
      <div className="px-4 pt-3 pb-2 flex justify-between items-center border-b"
        ...
        <div>
          ...
          <div className="flex items-center">
            ...
            ></div>
            <span className="text-sm text-gray-600 dark:text-gray-300">{match.squad}</span>
          </div>
        </div>
      ...
      <div className="p-4">
        ...
        <div className="mb-4 border rounded-md overflow-hidden">
          <div className="bg-gray-50 dark:bg-gray-700/50 px-3 py-2 flex justify-between items-center">
            <div className="text-xs font-light text-gray-500 dark:text-gray-500">Base Points</div>
          ...
          {match.boost_label && (
            ...
            >
              <div className="flex items-center">
                <span className="text-xs font-semibold mr-1.5 text-gray-800 dark:text-gray-200">
                  Boost: {match.boost_label}
                </span>
                {getRoleIcon(match.boost_label, 16, squadColor)}
              </div>
              <div className="text-sm font-medium text-gray-800 dark:text-gray-200">+{boostPoints}</div>
            </div>
          )}
          
          <div className="bg-gray-50 dark:bg-gray-700/50 px-3 py-2 flex justify-between items-center">
            <div className="text-xs font-semibold text-gray-700 dark:text-gray-300">TOTAL POINTS</div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
          {/* Batting Stats */}
          {match.batting && (
            <div className="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-3 h-full">
              ...
              <div className="flex flex-wrap gap-1.5 text-xs text-gray-600 dark:text-gray-400">
                {match.batting.fours > 0 && (
                  <div className="inline-flex items-center bg-gray-100 dark:bg-gray-600/50 px-1.5 py-0.5 rounded whitespace-nowrap">
          ...
          {match.fielding && (
            <div className="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-3 h-full">
              ...
              <div className="flex flex-wrap gap-1.5 text-sm font-semibold text-gray-800 dark:text-gray-200">
                {match.fielding.catches > 0 && (
                  <div className="inline-flex items-center bg-gray-100 dark:bg-gray-600/50 px-2 py-1 rounded whitespace-nowrap">
      ...
      <table className="w-full divide-y divide-gray-200 dark:divide-gray-700 table-fixed">
        <thead>
          <tr className="bg-gray-50 dark:bg-gray-900/50">
            <th className="px-1 sm:px-4 py-1 sm:py-2 text-left text-[9px] sm:text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider w-[25%]">Squad</th>
            <th className="px-1 sm:px-4 py-1 sm:py-2 text-left text-[9px] sm:text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider w-[15%]">Match</th>
            <th className="px-1 sm:px-4 py-1 sm:py-2 text-left text-[9px] sm:text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider w-[15%]">Base</th>
            <th className="px-1 sm:px-4 py-1 sm:py-2 text-left text-[9px] sm:text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider w-[15%]">Boost</th>
            <th className="px-1 sm:px-4 py-1 sm:py-2 text-left text-[9px] sm:text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider w-[15%]">Total</th>
            <th className="px-1 sm:px-4 py-1 sm:py-2 text-left text-[9px] sm:text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider w-[15%]">Avg</th>
          </tr>
        </thead>
        <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
          {seasonStats.map((stat, index) => (
            ...
            >
              <td className="px-1 sm:px-4 py-1 sm:py-2 whitespace-nowrap text-[10px] sm:text-sm text-gray-900 dark:text-white truncate">{stat.squad}</td>
              <td className="px-1 sm:px-4 py-1 sm:py-2 whitespace-nowrap text-[10px] sm:text-sm text-gray-700 dark:text-gray-300">{stat.matches}</td>
              <td className="px-1 sm:px-4 py-1 sm:py-2 whitespace-nowrap text-[10px] sm:text-sm text-gray-700 dark:text-gray-300">{stat.basePoints}</td>
              <td className="px-1 sm:px-4 py-1 sm:py-2 whitespace-nowrap text-[10px] sm:text-sm text-gray-700 dark:text-gray-300">{stat.boostPoints}</td>
              <td className="px-1 sm:px-4 py-1 sm:py-2 whitespace-nowrap text-[10px] sm:text-sm text-gray-700 dark:text-gray-300">{stat.totalPoints}</td>
